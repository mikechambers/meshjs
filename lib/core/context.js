export default class Context2D {
  constructor(
    ...
    /*
    //canvasstate properties we can filter
    strokeStyle, fillStyle, globalAlpha, lineWidth, lineCap, lineJoin, miterLimit,
    lineDashOffset, shadowOffsetX, shadowOffsetY, shadowBlur, shadowColor, filter,
  ...
  clear() {
    ...
    if (this._backgroundColor === undefined) {
      ...
      //this.fillStyle = this._backgroundColor.toCSS();
